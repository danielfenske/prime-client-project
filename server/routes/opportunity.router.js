...
router.put('/:id', rejectUnauthenticated, (req, res) => {
  ...
  pool.query(sqlText, [req.body.name, req.body.status, req.body.due_date, req.body.type, req.body.community_name, req.body.development_type, req.body.address_line_1, req.body.city, req.body.state, req.body.zip, req.body.tax_rate, req.body.opportunity_code, req.body.partner_id, req.body.contact_id, opportunityCode])
    .then(() => {
      res.sendStatus(200);
    }).catch((error) => {
      console.log(error);
